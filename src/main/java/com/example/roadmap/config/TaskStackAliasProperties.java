...
public record TaskStackAliasProperties(
    ...
    private static final String DEFAULT_PO = "po,product owner,product-owner,stack po";
    private static final String DEFAULT_SQC = "sqc,quality,quality control,stack sqc";
    ...
    public TaskStackAliasProperties {
        ...
        po = defaultIfBlank(po, DEFAULT_PO);
        sqc = defaultIfBlank(sqc, DEFAULT_SQC);
    }

    public static TaskStackAliasProperties defaults() {
        return new TaskStackAliasProperties(null, null, null, null, null, null);
    }
