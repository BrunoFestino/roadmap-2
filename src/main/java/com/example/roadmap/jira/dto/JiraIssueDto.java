...
public record JiraIssueDto(String key, Fields fields) {
  ...
  public static final class Fields {
    ...
    /** Returns the Jira key held by a scripted issue-link field. */
    public String customFieldIssueKey(String fieldId) {
      Object value = customFields.get(fieldId);
      ...
      if (value instanceof Map<?, ?> map) {
        ...
        return key == null || String.valueOf(key).isBlank() ? null : String.valueOf(key).trim();
      }
      return null;
    }
